...
namespace FileCabinetApp.Validators
{
    ...
    public class DefaultValidator : IRecordValidator
    {
        ...
        /// firstName - The {nameof(firstName)} length can't be less than 2 symbols and larger than 60 symbols.
        /// or
        /// firstName - The {nameof(firstName)} can't consists only from spases.
        /// or
        /// lastName - The {nameof(lastName)} length can't be less than 2 symbols and larger than 60 symbols.
        /// or
        ...
        public void ValidateParameters(string firstName, string lastName, DateTime dateOfBirth, char gender, short office, decimal salary)
        {
            ...
            {
                throw new ArgumentException(nameof(firstName), $"The {nameof(firstName)} length can't be less than 2 symbols and larger than 60 symbols.");
            }
            ...
            {
                throw new ArgumentException(nameof(lastName), $"The {nameof(lastName)} length can't be less than 2 symbols and larger than 60 symbols.");
            }
