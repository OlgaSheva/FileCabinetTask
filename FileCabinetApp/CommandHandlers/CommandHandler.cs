...
namespace FileCabinetApp.CommandHandlers
{
    public class CommandHandler : CommandHandlerBase
    {
        ...
        public override AppCommandRequest Handle(AppCommandRequest request)
        {
            ...
            {
                Program.fileCabinetService = CreateServise(Program.validationRules, Program.serviceType, out converter, out validator);
            }
        ...
        private static IFileCabinetService CreateServise(string validationRules, ServiceType serviceType, out IInputConverter converter, out IInputValidator validator)
        {
            ...
            switch (serviceType)
            {
                case ServiceType.File:
                    ...
                    Program.fileCabinetService = (validationRules == CustomValidationType)
            ...
            return Program.fileCabinetService;
        }
