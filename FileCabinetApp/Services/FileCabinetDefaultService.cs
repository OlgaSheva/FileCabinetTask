...
namespace FileCabinetApp.Services
{
    ...
    public class FileCabinetDefaultService : FileCabinetService
    {
        ...
        /// </exception>
        public override void ValidateParameters(string firstName, string lastName, DateTime dateOfBirth, Gender gender, char materialStatus, short catsCount, decimal catsBudget)
        {
            if (firstName == null)
            {
